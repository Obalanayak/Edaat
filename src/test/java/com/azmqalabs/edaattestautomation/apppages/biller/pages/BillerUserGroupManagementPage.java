...
public class BillerUserGroupManagementPage extends BasePage
{
	...
	public void ViewUsers(Map<Object, Object> testdatamap,Log Log) throws Exception {
		try {
			...
			Thread.sleep(20000);
			 ...
			 test.log(Status.PASS,"addGrop is successful" + driver.getTitle() +" * User Group Management PASS * " );	
	...
	//		VerifyValue1(getText(EdaatOR.Biller_SearchGroupMgm_GrpName), testdatamap.get("ArabicName").toString());
			VerifyValue1(getText(EdaatOR.Biller_SearchGroupMgm_Code), testdatamap.get("GroupCode").toString());
			test.log(Status.PASS,"Search Group is successful" + driver.getTitle() +" * User Group Management PASS * " );	
        	Log.ReportEvent("PASS", " Verify to Search new group");
        	this.takeScreenShot();

		}
		catch(Exception e){
			test.log(Status.FAIL,"Search Group is Failed" + driver.getTitle() +" * User Group Management  FAIL * " );
			this.takeScreenShot();
		}
	...
	public void deleteGroup(Map<Object, Object> testdatamap,Log Log) throws Exception {
		try {
			...
			test.log(Status.PASS,"Delete Group is successful" + driver.getTitle() +" * User Group Management PASS * " );	
        	Log.ReportEvent("PASS", " Verify to Deiete new group");
        	this.takeScreenShot();

		}
		catch(Exception e){
			test.log(Status.FAIL,"Delete Group is Failed" + driver.getTitle() +" * User Group Management  FAIL * " );
			this.takeScreenShot();
	...
	public void updateAndViewGroupPermission(Map<Object, Object> testdatamap,Log Log) throws Exception {
		try {
			...
			test.log(Status.PASS,"update Group is successful" + driver.getTitle() +" * User Group Management PASS * " );	
		}
		catch(Exception e){
			test.log(Status.FAIL,"update Group is Failed" + driver.getTitle() +" * User Group Management  FAIL * " );
			this.takeScreenShot();
		}
	   ...
	   //Parameter Summary  : Expected
		public void AddGroupErrorMsgValidation(Map<Object, Object> testdatamap) {
			try
			{
				...
				if(ExistsCheck(EdaatOR.Biller_GrpMgm_GrpCodeError))
				{
					...
					test.log(Status.PASS, "GroupMng EnterGroupCode ErrorMessage Exists" + driver.getTitle() + " * EnterGroupCode ErrorMessage Exists * ");
				}
					...
					test.log(Status.PASS, "GroupMng EnterEngGroupName ErrorMessage Exists" + driver.getTitle() + " * EnterEngGroupName ErrorMessage Exists * ");
				}
					...
					test.log(Status.PASS, "GroupMng EnterArbGroupName ErrorMessage Exists" + driver.getTitle() + " * EnterArbGroupName ErrorMessage Exists * ");
				}
					...
					test.log(Status.PASS, "GroupMng EngGroupName ErrorMessage Exists" + driver.getTitle() + " * EngGroupName ErrorMessage Exists * ");
				}
					...
					test.log(Status.PASS, "GroupMng ArbGroupName ErrorMessage Exists" + driver.getTitle() + " * ArbGroupName ErrorMessage Exists * ");
				}
					...
					test.log(Status.PASS, "GroupMng GroupCode ErrorMessage Exists" + driver.getTitle() + " * GroupCode ErrorMessage Exists * ");
				}
	            else {
				...
				test.log(Status.FAIL,"Group Management Add Group" + driver.getTitle() +" * Group Management Add Group FAIL * " );
		...
		public void VerifyCustomReconciliationReportAppearsIntheGroupPermission(Map<Object, Object> testdatamap,Log Log) throws Exception {
			try {
				...
				test.log(Status.PASS,"Verify that the Custom reconciliation report appears in the  Group Permission is successful" + driver.getTitle() +" * PASS * " );	
			}
			catch(Exception e){
				test.log(Status.FAIL,"Verify that the Custom reconciliation report appears in the  Group Permission is Failed" + driver.getTitle() +" *FAIL * " );
