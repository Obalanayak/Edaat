...
//Function Summary   : Method to Verify SubBiller Check Boxes in Custom Reconciliation Report
		...
		public void VerifySubBillerCheckBoxesInCustomReconciliationReport(Log Log)
		{
			try {
				...
				Thread.sleep(1000);
			    test.log(Status.PASS," Verify SubBiller Check Boxes in Custom Reconciliation Report" + driver.getTitle()+ " * Verify SubBiller Check Boxes in Custom Reconciliation Report PASS * " );
			...
			//Function Summary   : Method to validate Export To Excel Functionality			
				public void validateExportToExcelFunctionality(Map<Object,Object> testdatamap,Log Log) throws InterruptedException
				{
					try {
						...
						test.log(Status.PASS,"validate Export To Excel Functionality" + driver.getTitle() +" *Export to Excel PASS * " );
						Log.ReportEvent("PASS", " validate Export To Excel Functionality is sucessfull");
						 this.takeScreenShot();

					  }		catch(Exception e){
						  
						test.log(Status.FAIL,"validate Export To Excel Functionality " + driver.getTitle() +" *Export to Excel FAIL * " );
						 this.takeScreenShot();
					}
				}
		...
		public void verifyPaginationInTheReport(Map<Object,Object> testdatamap,Log Log) {
			try {
		    	...
		    	if(options.size()==4) {	    	
	    			...
	    			test.log(Status.PASS,"Verify the pagination in the report" + driver.getTitle() +" * Verify the pagination in the report is successfull PASS * " );
		...
		//Function Summary   : Method to validate Search Button Is clickable Functionality			
				public void validateSearchButtonIsClickableFunctionality(Map<Object,Object> testdatamap,Log Log) throws InterruptedException
				{
					try {
						...
						test.log(Status.PASS,"verify Search button is clickable " + driver.getTitle() +" *Search button clickable PASS * " );
						Log.ReportEvent("PASS", "verify Search button is clickable is sucessfull");
						 this.takeScreenShot();

					  }		catch(Exception e){
						  
						test.log(Status.FAIL,"verify Search button is clickable " + driver.getTitle() +" *Search button clickable FAIL * " );
						 this.takeScreenShot();
					}
				}
				...
				public void validateCheckingAndUncheckingReportsCheckboxChangesInGridData(Map<Object,Object> testdatamap,Log Log) throws InterruptedException
				{
					try {
						...
						test.log(Status.PASS,"validate CheckingAndUnchecking Reports checkbox Changes In GridData " + driver.getTitle() +" *validate CheckingAndUnchecking Reports Fields PASS * " );
						Log.ReportEvent("PASS", "validate CheckingAndUnchecking Reports checkbox Changes In GridData is sucessfull");
						 this.takeScreenShot();

					  }		catch(Exception e){
						  
						test.log(Status.FAIL,"validate CheckingAndUnchecking Reports checkbox Changes In GridData " + driver.getTitle() +" *validate CheckingAndUnchecking Reports Fields FAIL * " );
						 this.takeScreenShot();
					}
				}
