	...
	//Function Summary   : Method to verify terms Search Functionality
			...
			public void VerifySearchTerm(Map<Object,Object>testdatamap,Log Log) throws Exception {
				try {
					...
					VerifyValue1(getText("(//tr/td[contains(text(),'"+testdatamap.get("EnglishName").toString()+"')])[1]"),testdatamap.get("EnglishName").toString());
					test.log(Status.PASS,"Verify Search Terms is successful" + driver.getTitle() +" * Verify Search Terms is PASS * " );	
				  	Log.ReportEvent("PASS", " Verify search Term is Successful");
				  	this.takeScreenShot();
				}
				catch(Exception e){
					test.log(Status.FAIL,"Verify Search Terms is FAIL" + driver.getTitle() +" * Verify Search Terms is FAIL * " );
				...
				public void VerifyToviewActiveTerm(Map<Object, Object> testdatamap,Log Log) {
					 try {
						...
						public void DeleteTermButton(Map<Object, Object> testdatamap,Log Log) throws Exception
						{
							...
							test.log(Status.PASS,"Verify Delete Term is successful" + driver.getTitle() +" *Delete Term is successful PASS * " );
						...
						public void AddTerm(Map<Object,Object>testdatamap) {
							...
							try {
								...
								test.log(Status.PASS,"Add terms " + driver.getTitle() +" * Add Terms PASS * " );	
							    this.takeScreenShot();

							}
							catch(Exception e){
								test.log(Status.FAIL,"Add Terms " + driver.getTitle() +" * Add Terms FAIL * " );
								this.takeScreenShot();
                          ...
                          public void AddTermErrorMessageValidation(Map<Object,Object>testdatamap) {
							...
							try {
								if(ExistsCheck(EdaatOR.Biller_Settings_TermArabicNameError)) {
									...
									test.log(Status.PASS, "Terms Management Term ArabicName Error Message Exists" + driver.getTitle() + " * Terms Management Term ArabicName Error Message Exists * ");	    	
							     }
									...
									test.log(Status.PASS, "Terms Management Term EnglishName Error Message Exists" + driver.getTitle() + " * Terms Management Term EnglishName Error Message Exists * ");
								}
									...
									test.log(Status.PASS, "Terms Management Term ArabicText Error Message Exists" + driver.getTitle() + " * Terms Management Term ArabicText Error Message Exists * ");
								}
