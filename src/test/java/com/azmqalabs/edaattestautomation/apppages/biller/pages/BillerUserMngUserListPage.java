...
public class BillerUserMngUserListPage extends BasePage
{
	...
	public void verifyDeleteUser(Map<Object,Object> testdatamap,Log Log) throws Exception {
		try {
			...
			test.log(Status.FAIL,"Delete User from userlist and IsDelete User check box" + driver.getTitle() +" * User Management  FAIL * " );
			this.takeScreenShot();
		}
	}
	...
	public void verifyAddUser(Map<Object,Object> testdatamap,Log Log) throws Exception {
		try {
			...
			verifyElementIsNotPresent(EdaatOR.Biller_Product_NoData, "Data is exists");
			test.log(Status.PASS,"Add User from userlist" + driver.getTitle() +" * User Management PASS * " );	
        	Log.ReportEvent("PASS", " Verify to add new user account");
        	this.takeScreenShot();
		}
		catch(Exception e){
			test.log(Status.FAIL,"Add User from userlist" + driver.getTitle() +" * User Management  FAIL * " );
			this.takeScreenShot();
		}
	}
	...
	public void verifySearchUser(Map<Object,Object> testdatamap,Log Log) throws Exception {
		try {
			...
			test.log(Status.PASS,"Search User from userlist and User is clickable" + driver.getTitle() +" * User list Management PASS * " );	
        	Log.ReportEvent("PASS", " Verify Search functionality");
        	this.takeScreenShot();
		}
		catch(Exception e){
			test.log(Status.FAIL,"Search User from userlist and User is clickable" + driver.getTitle() +" * User List Management  FAIL * " );
			this.takeScreenShot();
		}
	}
public void ClickOnEditUser(String UserName ) {
	...
	public void verifyEditUser(Map<Object, Object> testdatamap,Log Log){
		...
		test.log(Status.PASS,"Edit User userlist is successfull" + driver.getTitle() +" * User list Management Edit PASS * " );
    	Log.ReportEvent("PASS", " Verify Edit user");
    	this.takeScreenShot();
		}
		catch (Exception e) {
			
		test.log(Status.FAIL,"Edit User userlist is successfull" + driver.getTitle() +" * User list Management FAIL * " );
...
//Function Summary  : Method to verifyAddUserErrorMsg
	...
	public void verifyAddUserErrorMsg(Map<Object, Object> testdatamap) throws Exception {
		...
		if(ExistsCheck(EdaatOR.Biller_UserList_NameErrorMsg))
		{
			...
			test.log(Status.PASS, "UserListUserName ErrorMessage Exists" + driver.getTitle() + " * UserListUserName ErrorMessage Exists * ");
		}
		else if (ExistsCheck(EdaatOR.Biller_UserList_PhonenoErrorMsg)&&ExistsCheck(EdaatOR.Biller_UserList_NameErrorMsg)&&ExistsCheck(EdaatOR.Biller_UserList_EmailErrorMsg))
		{
			...
			test.log(Status.PASS, "UserListPhone ErrorMessage Exists" + driver.getTitle() + " * UserListEmail ErrorMessage Exists * ");
		}		
			...
			test.log(Status.PASS, "UserListEmail ErrorMessage Exists" + driver.getTitle() + " * UserListEmail ErrorMessage Exists * ");			
		}
		...
		{	
			...
			Thread.sleep(1000);
			test.log(Status.PASS, "UserList Emailalreadyinuse ErrorMessage Exists" + driver.getTitle() + " * UserListEmailalreadyinuse ErrorMessage Exists * ");
		}
		...
		else if (ExistsCheck(EdaatOR.Biller_UserList_GroupErrorMsg))
		{
			...
			test.log(Status.PASS, "UserListGroup ErrorMessage Exists" + driver.getTitle() + " * UserListGroup ErrorMessage Exists * ");
		}
		else
		{
			...
			test.log(Status.FAIL,"UserList Add User" + driver.getTitle() +" * UserList Add User FAIL * " );
