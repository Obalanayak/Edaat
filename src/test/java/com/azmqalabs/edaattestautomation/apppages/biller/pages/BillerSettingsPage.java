...
public class BillerSettingsPage extends BasePage
{
	...
	public void AddInvoicetemplate(String TemplateArabic,String TemplateEnglish,String InvoiceType,String TemplateReferancecode,String TemplateDescription,Log Log){
		...
		//	i added these two
			...
			if(Ele==true) {
				test.log(Status.PASS,"Search Template" + driver.getTitle() +" * Search Template PASS * " );

			}else
				test.log(Status.FAIL,"Search Template" + driver.getTitle() +" * Search Template FAIL * " );
			

			Thread.sleep(1000);
			
		test.log(Status.PASS,"Add New Template client" + driver.getTitle() +" *Add New Template PASS * " );
    	Log.ReportEvent("PASS", " Verify Add Invoice Template is Suceessful");
    	this.takeScreenShot();

		}catch(Exception e){
			test.log(Status.FAIL,"Add New Template client" + driver.getTitle() +" * Add New Template client FAIL * " );
			this.takeScreenShot();
		}
	}
...
//Parameter Summary : N/A
		...
		public void VerifyUploadBulkData(Log Log) throws IOException, Exception {
			try {
				...
				test.log(Status.FAIL,"Upload bulk data " + driver.getTitle() +" * Upload bulk data FAIL * " );
				this.takeScreenShot();
	...
	//Parameter Summary : N/A
		...
		public void VerifyToUploadBulkData(Map<Object, Object> testdatamap,Log Log) throws InterruptedException
			{
				try
				{
					...
					test.log(Status.FAIL,"Verify to upload Bulk data " + driver.getTitle() +" * Content Management FAIL * " );
					this.takeScreenShot();
				}
			}
		...
		public void AddProductErrorMessageValidation(Map<Object,Object>testdatamap) throws IOException, Exception {
			...
			try {
					...
					test.log(Status.PASS, "Product Management Product Name Error Message Exists" + driver.getTitle() + " * Product Management Product Name Error Message Exists * ");	    	
			     }
					...
					test.log(Status.PASS, "Product Management Product Category Error Message Exists" + driver.getTitle() + " * Product Management Product Category Error Message Exists * ");
				}
					...
					test.log(Status.PASS, "Product Management Product BasePrice Error Message Exists" + driver.getTitle() + " * Product Management Product BasePrice Error Message Exists * ");
				}
				else if(ExistsCheck(EdaatOR.Biller_Settings_ProArabicNameError)){
					VerifyValue(Expected,EdaatOR.Biller_Settings_ProArabicNameError);
					test.log(Status.PASS, "Product Management Product Name Error Message Exists" + driver.getTitle() + " * Product Management Product BasePrice Error Message Exists * ");
				}
					...
					test.log(Status.PASS, "Product Management Product ReferenceCode Error Message Exists" + driver.getTitle() + " * Product Management Product ReferenceCode Error Message Exists * ");
				}
				else {
		...
		public void ContentMgmErrorMessageValidation(Map<Object, Object> testdatamap) throws InterruptedException
		{
			...
			try
			{
				if(ExistsCheck(EdaatOR.Biller_Settings_ContentMgmSelectFileError)) {
					...
					test.log(Status.PASS, "Content Management Product Upload BulkData Error Message Exists" + driver.getTitle() + " * Content Management Product Upload BulkData Error Message Exists * ");	    	
			     }
				...
				test.log(Status.FAIL,"Content Management Verify to upload Bulk data " + driver.getTitle() +" * Content Management Verify to upload Bulk data FAIL * " );
				this.takeScreenShot();
		...
		public void BillsCancelationErrorMessageValidation(Map<Object, Object> testdatamap) throws InterruptedException
		{
			...
			try
			{
				if(ExistsCheck(EdaatOR.Biller_Settings_BillsCancelationSelectFileError)) {
					...
					test.log(Status.PASS, "Bills Cancelation Upload BulkData Error Message Exists" + driver.getTitle() + " * Bills Cancelation  Upload BulkData Error Message Exists * ");	    	
			     }
					...
					test.log(Status.PASS, "Bills Cancelation Product Upload BulkData Error Message Exists" + driver.getTitle() + " * Bills Cancelation Upload BulkData Error Message Exists * ");
				}	
				else {
				...
				test.log(Status.FAIL,"Bills Cancelation Verify to upload Bulk data " + driver.getTitle() +" * Bills Cancelation Verify to upload Bulk data FAIL * " );	
				this.takeScreenShot();
		...
		public void AddInvoiceTemplateErrorMessageValidation(Map<Object, Object> testdatamap) throws InterruptedException
		{
			...
			try
			{
				...
				if(ExistsCheck(EdaatOR.Biller_Settings_TemplateArabicNameError)) {
					...
					test.log(Status.PASS, "Settings Add Template Error Message Exists" + driver.getTitle() + " * Settings Add Template Upload BulkData Error Message Exists * ");	    	
			     }
					...
					test.log(Status.PASS, "Settings Add Template Error Message Exists" + driver.getTitle() + " * Settings Add Template Error Message Exists * ");
				}	
				...
				test.log(Status.FAIL,"Settings Verify to Add Template " + driver.getTitle() +" * Settings  Verify to Add Template FAIL * " );	
			}
}
}