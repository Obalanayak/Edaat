...
public class BillerSettingPricelistPage extends BasePage {
	...
	public void VerifyViewPriceButton(Map<Object, Object> testdatamap,Log Log)
	{
		try {
			...
			test.log(Status.PASS,"View Price details" + driver.getTitle() +" * Pricing List view Price details PASS * " );	
        	Log.ReportEvent("PASS", " Verify  View Price details button functionality is Suceessfull");
        	this.takeScreenShot();

		}
		catch (Exception e) {
			test.log(Status.PASS,"View Price details" + driver.getTitle() +" * Pricing List view Price details FAIL * " );	
			 this.takeScreenShot();
		}
	}
	...
	public void addPriceList(Map<Object,Object>testdatamap,Log Log) {
		try {
	    	...
	    	test.log(Status.PASS,"Add price list" + driver.getTitle() +" *Add price list PASS * " );
        	Log.ReportEvent("PASS", " Verify Add pricing list is Suceessfull");
        	this.takeScreenShot();

		}
		catch(Exception e){
			test.log(Status.FAIL,"Add price list" + driver.getTitle() +" * Add price list FAIL * " );
			 this.takeScreenShot();
		}
}
	//Function Summary : Method to Search price list.
		...
		public void verifyPricelistgridview(Log Log) throws Exception {
			try {
				...
				test.log(Status.PASS,"Verify Navigate to pricelist page  and view records of Grid " + driver.getTitle() +" * Navigate to pricelist page  and view records of Grid is Pass * " );
	        	Log.ReportEvent("PASS", " Verify  View Price details button functionality is Suceessfull");
	        	this.takeScreenShot();
					...
					test.log(Status.FAIL,"Verify Navigate to pricelist page  and view records of Grid" + driver.getTitle() +" * Navigate to pricelist page  and view records of Grid is Fail* " );
					 this.takeScreenShot();
				}
			}
		...
		public void AddPriceListErrorMessageValidation(Map<Object,Object>testdatamap,Log Log) {
			...
			try {
				if(ExistsCheck(EdaatOR.Biller_Settings_PricelistArabicNameError)) {
					...
					test.log(Status.PASS, "Pricelist ArabicName Error Message Exists" + driver.getTitle() + " * Pricelist ArabicName Error Message Exists * ");	    	
			     }
					...
					test.log(Status.PASS, "Pricelist EnglishName Error Message Exists" + driver.getTitle() + " * Pricelist EnglishName Error Message Exists * ");
				}
					...
					test.log(Status.PASS, "Pricelist Increase or Decrease Ratio Error Message Exists" + driver.getTitle() + " * Pricelist Increase or Decrease Ratio Error Message Exists * ");
				}
					...
					test.log(Status.PASS, "Pricelist FromDate Error Message Exists" + driver.getTitle() + " * Pricelist FromDate Error Message Exists * ");
				}
					...
					test.log(Status.PASS, "Pricelist ToDate Error Message Exists" + driver.getTitle() + " * Pricelist ToDate Error Message Exists * ");
				}
					...
					test.log(Status.PASS, "Pricelist Rounding Radio Button Error Message Exists" + driver.getTitle() + " * Pricelist Rounding Radio Button Error Message Exists * ");
				}
				...
				Log.ReportEvent("PASS", " Verify  Verify Add Pricelist Error Message functionality is Suceessfull");
				this.takeScreenShot();
			}
			catch(Exception e){
				test.log(Status.FAIL,"Add price list" + driver.getTitle() +" * Add price list FAIL * " );
