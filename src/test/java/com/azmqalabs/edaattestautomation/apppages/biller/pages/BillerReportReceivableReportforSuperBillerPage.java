...
public class BillerReportReceivableReportforSuperBillerPage extends BasePage
{
	...
	public WebElement Client;
	 ...
	 public void VerifyCorportaeClientsReport(Map<Object, Object> testdatamap,Log Log) throws Exception {
		 try{
			 ...
			 test.log(Status.PASS," Verify Corporate Client Report" + driver.getTitle() +" * Verify Corporate Client Report is PASS * " );	
				Log.ReportEvent("PASS", " Verify Supper Biller Corporate Client Report is Suceessful");
				 this.takeScreenShot();
				
     }catch(Exception e){
      test.log(Status.FAIL, "Verify Corporate Client Report " + driver.getTitle() + " * Verify Corporate Client Report is FAIL * ");
      this.takeScreenShot();
     }
	...
	public void VerifySubBillersReport(Map<Object, Object> testdatamap,Log Log) {
		...
		test.log(Status.PASS," Verify Sub Billers Report " + driver.getTitle() +" * Sub Billers Report PASS * " );
		Log.ReportEvent("PASS", " Verify Sub Biller Generate Report is Suceessful");
		 this.takeScreenShot();

		}
		catch (Exception e) {
			test.log(Status.FAIL," Verify Sub Billers Report " + driver.getTitle() +" * Sub Billers Report FAIL * " );	
			 this.takeScreenShot();
		}
	}
	 ...
	 public void VerifyClientAccountStatementReport(Map<Object, Object> testdatamap,Log Log)
	 {
	   try {
		...
		//	WebEdit(EdaatOR.Biller_Invoicecontract,testdatamap.get("Invoice Contract").toString());
	        ...
	        Thread.sleep(1000);
		    test.log(Status.PASS,"Verify Client Account Statement Report" + driver.getTitle() +" * Verify Client Account Statement Report Pass * " );
		 ...
		 {
			 test.log(Status.FAIL,"Verify Client Account Statement Report" + driver.getTitle() +" * Verify Client Account Statement Report FAIL * " );
			 this.takeScreenShot();
		 }
...
public void SelectDate(Map<Object, Object> testdatamap)
{
	 ...
	 public void VerifySadadPaymentsTransactions(Map<Object, Object> testdatamap,Log Log)
    {
		 try{
            ...
            switchBacktoParentwindow();
            test.log(Status.PASS,"Verify Sadad Payments Report " + driver.getTitle() +" * Sadad Payments Report  is PASS * " );
       	 ...
       	 test.log(Status.FAIL,"Sadad Payments Report  Report " + driver.getTitle() +" * Sadad Payments Report  is FAIL * " );
       	 this.takeScreenShot();
    }
	 }
	 //Function Summary  : Method to Select Client type. 
