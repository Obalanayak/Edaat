...
public class BillerSettingsDiscountPage extends BasePage
{
	...
	public void ActivateDiscount(Map<Object,Object> testdatamap,Log Log) {
		try {
			...
			test.log(Status.PASS,"Activate Discount" + driver.getTitle() +" * Activate Discount PASS * " );
        	Log.ReportEvent("PASS", " Verify to add discount and activate Suceessfull");
        	this.takeScreenShot();
		}
		catch(Exception e){
			test.log(Status.FAIL,"Activate Discount" + driver.getTitle() +" * Activate Discount FAIL * " );
			this.takeScreenShot();
		}
		...
		public void VerifyDiscoutStatusToggel(Map<Object, Object> testdatamap,Log Log)
		{
			try {
				...
				Thread.sleep(1000);
				WebClick(EdaatOR.Biller_settings_Discount_confyesbtn);
				test.log(Status.PASS,"Verify Status Toggel" + driver.getTitle() +" * Discount management Status Toggel PASS * " );
	        	Log.ReportEvent("PASS", " Verify Verify status toggel functionality is Suceessfull");
	        	this.takeScreenShot();
				}
				else
				{
				test.log(Status.FAIL,"Verify Status Toggel" + driver.getTitle() +" * Discount management Status Toggel Fail * " );
				}
			}
			catch (Exception e) {
	...
	public void AddDiscountDeactivate(Map<Object,Object> testdatamap,Log Log) throws InterruptedException
	{
		try {
			...
			test.log(Status.FAIL,"AddDiscountDeactivate" + driver.getTitle() +" * AddDiscountDeactivate FAIL * " );
			this.takeScreenShot();
		}
	...
	public void DeactiveToggle() 
	{
	  try {
		     ...
		     if(CheckElementExists(EdaatOR.Biller_Discount_Deact_confirm)==true)
		     {
		        ...
		        Thread.sleep(1500);
		        test.log(Status.PASS,"DeactiveToggle" + driver.getTitle() +" * DeactiveToggle PASS * " );
			    
		      }
	      }
		catch(Exception e){
			test.log(Status.FAIL,"DeactiveToggle" + driver.getTitle() +" * DeactiveToggle FAIL * " );
			this.takeScreenShot();
		}
	}
	...
	public void AddDiscountErrorMessageValidation(Map<Object,Object>testdatamap) throws IOException, Exception {
		...
		try {
				...
				test.log(Status.PASS, "Discount Management Discount EnglishName Error Message Exists" + driver.getTitle() + " * Discount Management Discount EnglishName Error Message Exists * ");	    	
		     }
				...
				test.log(Status.PASS, "Discount Management Discount ArabicName Error Message Exists" + driver.getTitle() + " * Discount Management Discount ArabicName Error Message Exists * ");
			}
				...
				test.log(Status.PASS, "Discount Management Discount Percentage Error Message Exists" + driver.getTitle() + " * Discount Management Discount Percentage Error Message Exists * ");
			}
			else if(ExistsCheck(EdaatOR.Biller_Settings_DiscArabicNameError)){
				VerifyValue(Expected,EdaatOR.Biller_Settings_DiscArabicNameError);
				test.log(Status.PASS, "Discount Management Discount ArabicName Error Message Exists" + driver.getTitle() + " * Discount Management Discount ArabicName Error Message Exists * ");
			...
			test.log(Status.FAIL,"Verify Error Messages for Add Discount" + driver.getTitle() +" * Error Messages for Add Discount FAIL * " );
			this.takeScreenShot();
		}
	}
