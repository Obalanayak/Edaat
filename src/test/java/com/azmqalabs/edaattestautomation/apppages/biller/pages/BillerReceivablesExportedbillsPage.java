...
//				verifyElementIsPresent(EdaatOR.Biller_Invoice_ContractNumber);
	...
	public void verifyNewlyAddedPaymentMethodColumnInGrid(Log Log) throws Exception
	{
		...
		test.log(Status.PASS,"verify Newly Added PaymentMethod Column In Grid" + driver.getTitle() +" * verify Newly Added PaymentMethod is Pass * " );
		...
		try {
	    	...
	    	if(options.size()==7) {	    	
	    		for (Object option:options){
	    			...
	    			test.log(Status.PASS,"verify new search criteria in Exported contracts page for the payment method" + driver.getTitle() +" *  verify new search criteria in Exported contracts page for the payment method is successfull PASS * " );
	...
	public void verifyPaymentMethodLogoInContractNumber(Map<Object,Object> testdatamap,Log Log) throws Exception {
		try {
			...
			if(iType.equalsIgnoreCase("ExportContact")) {
				...
				test.log(Status.PASS,"verify available payment method appear as logo when click on contract number" + driver.getTitle() +" * verify available payment method appear as logo when click on contract number PASS * " );
				Log.ReportEvent("PASS", " verify available payment method appear as logo when click on contract number");
				this.takeScreenShot();
			}
		}
		catch(Exception e){
			test.log(Status.FAIL,"verify available payment method appear as logo when click on contract number" + driver.getTitle() +" * verify available payment method appear as logo when click on contract number * " );
			this.takeScreenShot();
		}
	}
		...
		public void verifyPaymentMethodLogoInBillNumber(Map<Object,Object> testdatamap,Log Log) throws Exception {
			try {
				...
				if(iType.equalsIgnoreCase("ExportContact")) {
					...
					verifyElementIsPresent(EdaatOR.Biller_ExportContact_PaymentMethodLogo_Visa);
					verifyElementIsPresent(EdaatOR.Biller_ExportContact_PaymentMethodLogo_MasterCard);
					test.log(Status.PASS,"verify that the available payment method appears when click on view button of an invoice" + driver.getTitle() +" * verify that the available payment method appears when click on view button of an invoice PASS * " );
					Log.ReportEvent("PASS", " verify that the available payment method appears when click on view button of an invoice");
					this.takeScreenShot();
				}
			}
			catch(Exception e){
				test.log(Status.FAIL,"verify that the available payment method appears when click on view button of an invoice" + driver.getTitle() +" * verify that the available payment method appears when click on view button of an invoice FAIL * " );
				this.takeScreenShot();
			}
		}
...
//				VerifyValue1(getText(EdaatOR.Biller_ExportBills_error),testdatamap.get("Error").toString());
				test.log(Status.PASS,"create invoice with only paid outside edaat payment method" + driver.getTitle() +" * PASS * " );				
				takeScreenShot();
			...
			test.log(Status.FAIL,"create invoice with only paid outside edaat payment method" + driver.getTitle() +" *FAIL * " );
			this.takeScreenShot();
		}
	}
	...
	public void verifyMaxLengthOfTransferRemarkField(Map<Object,Object> testdatamap,Log Log) throws Exception {
		try {
				...
				Thread.sleep(1000);
				ClickOnCreateInvoiceBtn();
				test.log(Status.PASS,"verify that text length is free text with max length 280 char" + driver.getTitle() +" * PASS * " );				
				takeScreenShot();
				Log.ReportEvent("PASS", "verify that text length is free text with max length 280 char");
				this.takeScreenShot();
		}
		catch(Exception e){
			test.log(Status.FAIL,"verify that text length is free text with max length 280 char" + driver.getTitle() +" *FAIL * " );
			this.takeScreenShot();
		}
	}
	...
	public void verifyPaymentMethodIsEditableForExportedContracts(Map<Object, Object> testdatamap, Log Log) throws Exception {
		...
		try {
			...
			if(CheckElementExists(EdaatOR.Biller_Receievables_PaymentMethod_Update_PopupHeader)) {
				...
				Thread.sleep(2000);
				test.log(Status.PASS,"verify that the payment methods is editable after the invoice partial paid is successfull" + driver.getTitle() +" * PASS * " );	
				Log.ReportEvent("PASS", " verify that the payment methods is editable after the invoice partial paid is successfull");
				this.takeScreenShot();
			}
			else
			{
				test.log(Status.FAIL,"verify that the payment methods is editable after the invoice partial paid is Unsuccessfull" + driver.getTitle() +" * FAIL * " );	
				this.takeScreenShot();
			}
	...
	//Function Summary   : Method to verify Default Payment Method Is Selected And Disabled
		...
		public void verifyDefaultPaymentMethodIsSelectedAndDisabled(Map<Object,Object> testdatamap,Log Log)
		{
			try {
				...
				{
					test.log(Status.PASS,"verify Default Payment Method Is Selected And Disabled" + driver.getTitle() +" * verify Default Payment Method Is Selected And Disabled PASS * " );
			...
			{
				test.log(Status.FAIL,"Verify Default Payment Method Is Selected And Disabled" + driver.getTitle() +" * verify Default Payment Method Is Selected And Disabled FAIL * " );
				this.takeScreenShot();
			}
		}
			catch(Exception e){
	...
	public void verifyPaymentMethodIsEditable(Map<Object, Object> testdatamap, Log Log) throws Exception {
		...
		try {
			...
			if(CheckElementExists(EdaatOR.Biller_Receievables_PaymentMethod_Update_PopupHeader)) {
				...
				test.log(Status.PASS,"verify that the available payment methods is editable after the invoice partially paid Functionality is successfull" + driver.getTitle() +" * verify that the available payment methods is editable after the invoice partially paid  Functionality is successfull PASS * " );	
			...
			{
				test.log(Status.FAIL,"verify that the available payment methods is editable after the invoice partially paid Functionality is Unsuccessfull" + driver.getTitle() +" * verify that the available payment methods is editable after the invoice partially paid  Functionality is Unsuccessfull FAIL * " );	
			}
	...
	public void searchExportedBillsUsingBillNUmber(Map<Object, Object> testdatamap, Log Log) throws Exception {
		try {
			...
			VerifyValue1(getText(EdaatOR.Biller_ReceivableExportedBills_BillNumber),testdatamap.get("BillNumber").toString());
				...
				e.printStackTrace();
				test.log(Status.FAIL,"search exported bills is Unsuccessfull" + driver.getTitle() +" *FAIL * " );
			}
	}
	...
	public void VerifyTransferRemarkFieldAppearsAfterSelectingSubBiller(Map<Object, Object> testdatamap, Log Log) throws Exception {
		try {
			...
			if (IsDispalyed(EdaatOR.Biller_Rece_Transfer_Remark_TestArea)) {
				...
				test.log(Status.PASS,"Verify Transfer Remark Field Appears After Selecting Sub Biller Functionality is successfull" + driver.getTitle() +" * Verify Transfer Remark Field Appears After Selecting Sub Biller Functionality is successfull PASS * " );	
		    	Log.ReportEvent("PASS", "Verify Transfer Remark Field Appears After Selecting Sub Biller Functionality is successfull");	
		    	this.takeScreenShot();
			}
			else {
				
				test.log(Status.FAIL,"Verify Transfer Remark Field Appears After Selecting Sub Biller Functionality is Unsuccessfull" + driver.getTitle() +" * Verify new payment method column is added Functionality is Unsuccessfull FAIL * " );	
			}
		  }
	catch (Exception e) {
			e.printStackTrace();
	   ...
	   //Parameter Summary :  InvoiceType,Save,TransferRemarkMessage,BilStatus
		...
		public void VerifyTransferRemarkFieldDoesntAppearAfterSelectingTemplateOtherThanOneTime(
			...
			try {
				...
				test.log(Status.PASS,"Verify Transfer Remark Field Doesnt Appear After Selecting Template Other Than One Time Functionality is successfull" + driver.getTitle() +" * Verify Transfer Remark Field Doesnt Appear After Selecting Template Other Than One Time Functionality is successfull PASS * " );	
				...
				test.log(Status.FAIL,"Verify Transfer Remark Field Doesnt Appear After Selecting Template Other Than One Time Functionality is Unsuccessfull" + driver.getTitle() +" * Verify Transfer Remark Field Doesnt Appear After Selecting Template Other Than One Time Functionality is Unsuccessfull FAIL * " );
				this.takeScreenShot();
			}
		}	
	...
	//Function Summary  : Method to verify Payment Methods List In Export Bills
			...
			try {	 
		    	...
		    	if(options.size()==7) {	    	
		    		for (Object option:options){
		    			...
		    			test.log(Status.PASS,"verify Payment Methods List In Export Bills" + driver.getTitle() +" *  verify Payment Methods List PASS * " );
		...
		public void verifyTransferRemarkFieldNotAppears(Map<Object,Object> testdatamap,Log Log) throws Exception {
			...
			try {
					...
					test.log(Status.PASS,"Verify Transfer Remark field is not displayed" + driver.getTitle() +" * Verify Transfer Remark field PASS * " );				
					takeScreenShot();
				...
				test.log(Status.FAIL,"Verify Transfer Remark field is not displayed" + driver.getTitle() +" * Verify Transfer Remark field Fail * " );				
				this.takeScreenShot();
			}
		}
				...
				public void verifyInvoiceDetailsPaymentMethodsEditable(Log Log) throws Exception {
					...
					try {								
							...
							Thread.sleep(100);
							test.log(Status.PASS,"Verify Payment Methods are Editable invoice details page" + driver.getTitle() +" * Payment methods editable PASS * " );				
				...
				public void verifyExportedContractsInvoiceDetailsPaymentMethodsEditable(Log Log) throws Exception {
					...
					try {								
						...
						test.log(Status.FAIL,"Verify Payment Methods are Editable invoice details page" + driver.getTitle() +" * Payment methods editable Fail * " );				
						this.takeScreenShot();
					}
				}
				...
				public void verifyPaymentMethodsLogoInInvoiceDetailsPage(Log Log) throws Exception {
					...
					try {
						...
						Thread.sleep(100);
						test.log(Status.PASS,"Method to verify Payment Methods Logo In Invoice Details Page" + driver.getTitle() +" * Method to verify Payment Methods Logo PASS * " );				
						takeScreenShot();
						...
						test.log(Status.FAIL,"Method to verify Payment Methods Logo In Invoice Details Page" + driver.getTitle() +" * Method to verify Payment Methods Logo Fail * " );				
						this.takeScreenShot();
					}
				}
}
