	  ...
	  //Function Parameters:Corporate,Individual.
		...
		public void VerifyClienttype(Map<Object, Object> testdatamap,Log Log) {
			...
			try{
                ...
                test.log(Status.FAIL,"#FUNC-Import Client data type" + driver.getTitle() +" * Import Client data type is FAIL * " );
                this.takeScreenShot();
        }
   }
		...
		public void VerifyDownloadBulkSheet(Map<Object, Object> testdatamap,Log Log) {
			try{				
                ...
                test.log(Status.FAIL,"#FUNC-Verify to download the bulk sheet" + driver.getTitle() +" * Download the bulk sheet is FAIL * " );
                this.takeScreenShot();
        }
		}
