  	...
  	public void AddPriceList(Map<Object, Object> testdatamap,Log Log)
  	{
		...
		Thread.sleep(2000);
      	...
      	PriceListSearch(testdatamap,Log);
  			...
  			e.printStackTrace();
  			this.takeScreenShot();
  			test.log(Status.FAIL,"#FUNC-Verify AddPriceList" + driver.getTitle() +" * Add Price List is Fail* " );
  		}
  	...
  	public void VerifyPriceListDelete(Map<Object,Object>testdatamap,Log Log) {
  		try {
        	...
        	Log.ReportEvent("PASS", " Verify delete price button");
  			...
  			e.printStackTrace();
  			this.takeScreenShot();
  			test.log(Status.FAIL,"#FUNC-Verify Delete Pricelist" + driver.getTitle() +" * Delete Pricelist is Fail* " );
  		}
	...
	public void VerifyGridView(Map<Object, Object> testdatamap,Log Log) {
		...
		try {
			...
			Log.ReportEvent("PASS", " Verify to Add price list is Suceessful");
				...
				e.printStackTrace();
				this.takeScreenShot();
				test.log(Status.FAIL,"#FUNC-Verify the grid view in Pricelist page " + driver.getTitle() +" * Verification in Pricelist page is Fail * " );
			}
		}
	...
	public void ViewPriceDetails(Map<Object,Object>testdatamap,Log Log)
  	{
  		try {
			...
			Log.ReportEvent("PASS", " Verify view price details is Suceessful");
  			...
  			e.printStackTrace();
  			this.takeScreenShot();
  			test.log(Status.FAIL,"#FUNC-Verify view details" + driver.getTitle() +" *View details is Fail* " );
  		}
