		...
		//Parameter Summary : N/A
			...
			public void  VerifyDeleteTerms(Map<Object,Object>testdatamap,Log Log)
			{
				try{
					...
					test.log(Status.FAIL,"#FUNC-Verify Send Email toggel FAIL" + driver.getTitle() +" * Verify to Delete Term Button is FAIL * " );
					this.takeScreenShot();	
					}				
}
	//Function Summary   : Method to Search Terms
		...
		public void VerifyToviewActiveTerm(Map<Object, Object> testdatamap,Log Log) {
			 try {
					...
					test.log(Status.FAIL,"#FUNC-view term details button" + driver.getTitle() +" * Verify view term details button is FAIL * " );
					this.takeScreenShot();
		...
		public void SettingsTermsManagementSearchTerm(Map<Object,Object>testdatamap,Log Log)
		{
        	...
        	Log.ReportEvent("PASS", "Verify search term functionality is Suceessful");
				...
				test.log(Status.FAIL,"#FUNC-Settings Terms Management Search Term" + driver.getTitle() +" SearchTerm is PASS * " );	
				this.takeScreenShot();
			}		
		}
		...
		public void VerifyTermsMgnActive(Map<Object, Object> testdatamap,Log Log) {
        	...
        	Log.ReportEvent("PASS", " Verify Super biller report is succesfull");
				...
				test.log(Status.FAIL,"#FUNC-Terms Management Active" + driver.getTitle() +" * Terms Management FAIL * " );
				this.takeScreenShot();
			}	
