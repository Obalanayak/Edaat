...
//Parameter Summary :N/A
	...
	/*public void paidOutsideEdaatSearch(Map<Object, Object> testdatamap) {
		try {
			...
			test.log(Status.FAIL,"#FUNC-Verify PaidOutsideEdaat Search" + driver.getTitle() +" * PaidOutsideEdaat Search is FAIL * " );
			this.takeScreenShot();
		}
	}*/
	...
	//Parameter Summary : TemplateName,Expected
		public void ReceivablesExportBillsCreate(Map<Object,Object> testdatamap) throws Exception {
			try {
				...
				test.log(Status.FAIL,"#FUNC-Verify Error message" + driver.getTitle() +" * Verify Error message is PASS * " );
				this.takeScreenShot();
			}
		}
		...
		public void TaxDiscountDetails(Map<Object,Object> testdatamap) throws Exception
		{
		 try {
		    ...
		    {
				test.log(Status.FAIL,"#FUNC-Verify Error message" + driver.getTitle() +" * Verify Error message is fail* " );
				this.takeScreenShot();
		}
	}
		...
		public void validateMinimumInvoiceAmount(Map<Object,Object> testdatamap,Log Log) throws Exception {
			try {
				...
				test.log(Status.FAIL,"#FUNC-validate minimum invoice amount in create invoice page" + driver.getTitle() +" * validate minimum invoice amount in create invoice page FAIL * " );
				this.takeScreenShot();
			}
		}		
