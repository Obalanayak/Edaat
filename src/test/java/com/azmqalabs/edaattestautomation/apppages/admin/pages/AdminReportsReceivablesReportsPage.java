...
public class AdminReportsReceivablesReportsPage extends BasePage
{
	...
	public void VerifyCorporateClientReport(Log Log) throws Exception {
		try{
			...
			test.log(Status.FAIL,"#FUNC-Verify Corporate Client report FAIL" + driver.getTitle() +" * Verify Corporate Client report FAIL * " );
			this.takeScreenShot();
		}
	}
	...
	public void VerifySadedPaymentsReport(Map<Object, Object> testdatamap,Log Log) throws Exception {
		try{
			...
			test.log(Status.FAIL,"#FUNC-Verify Saded Payment report FAIL" + driver.getTitle() +" * Verify Saded Payment report FAIL * " );
			this.takeScreenShot();
		}
	}
...
//			WebClickUsingActions("//li[text()='"+testdatamap.get("ClientName").toString()+"']");
	...
	public void VerifyIndividualClientsReport(Map<Object, Object> testdatamap,Log Log) throws Exception {
		try{
			...
			test.log(Status.FAIL, "#FUNC-Verify Individual Clients Report" + driver.getTitle() + " * Individual Clients Report FAIL * ");
			this.takeScreenShot();
		}
