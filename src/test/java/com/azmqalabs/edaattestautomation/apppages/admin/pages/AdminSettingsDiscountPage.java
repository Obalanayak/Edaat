...
//Function Parameters:ActivationMsg and DeactivationMsg.
	public void verifyAddDeactivateDiscount(Map<Object,Object> testdatamap,Log Log) throws Exception {
		try {
			...
			test.log(Status.FAIL,"#FUNC-Add Deactivate Discount" + driver.getTitle() +" * Add Deactivate Discount Fail * " );
			this.takeScreenShot();
		}
	}
	...
	public void SearchDiscount(Map<Object, Object> testdatamap,Log Log) throws Exception {
		...
		try {
			...
			test.log(Status.FAIL,"#FUNC-Search Discount" + driver.getTitle() +" * Search Discount Fail * " );
			this.takeScreenShot();
		}
	}
	...
	public void VerifyAddDiscountActivate(Map<Object,Object> testdatamap,Log Log) throws Exception {
		try {
			...
			test.log(Status.FAIL,"#FUNC-Add Activate Discount" + driver.getTitle() +" * Add Activate Discount Fail * " );
			this.takeScreenShot();
		}
	}
