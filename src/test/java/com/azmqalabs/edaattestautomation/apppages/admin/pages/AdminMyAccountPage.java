	...
	public void  VerifySendEmailtoggel(Log Log)
	{
		try{
			...
			Log.ReportEvent("PASS", " Verify  Send Email toggel is Sucessful");
				...
				test.log(Status.FAIL,"#FUNC-Verify Send Email toggel FAIL" + driver.getTitle() +" * Verify Send Email toggel FAIL * " );
				this.takeScreenShot();
			}
	}
		...
		public void  pushNotificationstoggle(Map<Object, Object>testdatamap,Log Log)
		{
			try{
		        ...
		        Log.ReportEvent("PASS", "Verify  Push Notifications toggle is Successfull");
					...
					test.log(Status.FAIL,"#FUNC-Verify Push Notifications toggle FAIL" + driver.getTitle() +" * Push Notifications toggle is FAIL * " );
					this.takeScreenShot();
				}
		}
