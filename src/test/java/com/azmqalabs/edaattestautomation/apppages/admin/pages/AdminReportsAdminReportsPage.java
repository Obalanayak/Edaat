...
public class AdminReportsAdminReportsPage extends BasePage
{
	...
	public void VerifySuperBillerReport(Map<Object,Object> testdatamap,Log Log) throws Exception {
		try {
			...
			test.log(Status.FAIL,"#FUNC-Sub biller report FAIL" + driver.getTitle() +" * Sub biller report FAIL * " );
			this.takeScreenShot();
		}
	}
	...
	public void VerifyOutsideEdaatPaymentReports(Map<Object,Object> testdatamap,Log Log) throws Exception {
		try {
			...
			test.log(Status.FAIL,"#FUNC-Outside edaat payments report FAIL" + driver.getTitle() +" *Outside edaat payments report FAIL * " );
			this.takeScreenShot();
		}
	}
...
//			WebClick(EdaatOR.Admin_Report_VerifyPID);
			...
			test.log(Status.FAIL,"#FUNC-Biller Transaction Report FAIL" + driver.getTitle() +" *Biller Transaction Report FAIL * " );
			this.takeScreenShot();
		}
	}
	...
	public void VerifyCorporateClientsReport(Map<Object,Object> testdatamap,Log Log) throws Exception {
		try {
			...
			this.takeScreenShot();
			switchBacktoParentwindow();
			test.log(Status.PASS,"#FUNC-VerifyCorporateClientsReport is Pass" + driver.getTitle() +" *VerifyCorporateClientsReport FAIL * " );
        	Log.ReportEvent("PASS", " Verify Corporate Client Report is Suceessful");

		}
		catch(Exception e){
			test.log(Status.FAIL,"#FUNC-VerifyCorporateClientsReport is FAIL" + driver.getTitle() +" *VerifyCorporateClientsReport * " );
			this.takeScreenShot();
		}
	}
...
//			WebClick(EdaatOR.Admin_Report_VerifyPID);
			...
			test.log(Status.FAIL,"#FUNC-Verify Biller Monitoring Report" + driver.getTitle() +" * Biller Monitoring Report FAIL * " );
		}
...
//			WebClick(EdaatOR.Admin_Report_VerifyPID);
			...
			test.log(Status.FAIL,"#FUNC-Verify Clients Type Report" + driver.getTitle() +" *Clients Type Report is Fail* " );
			this.takeScreenShot();
		}
	}
...
//			WebClick(EdaatOR.Admin_Report_VerifyPID);
			...
			test.log(Status.FAIL,"#FUNC-Verify Payment Transactions Report FAIL" + driver.getTitle() +" *Verify PaymentTransactions Report FAIL * " );
			this.takeScreenShot();
	...
	public void VerifyBlockedCorporateClientReport(Log Log) throws InterruptedException
	{
		try {
			...
			test.log(Status.FAIL,"#FUNC-Verify Blocked Corporate Client Report FAIL" + driver.getTitle() +" *Verify Blocked Corporate Client Report FAIL * " );
			this.takeScreenShot();	  
		}
	}
	...
	public void VerifyBlockedIndividualClientReport(Map<Object, Object> testdatamap,Log Log) {
		...
		{Thread.sleep(2000);
			...
			test.log(Status.FAIL,"#FUNC-Verify Blocked Individual Clients Report" + driver.getTitle() +" * Blocked Individual Clients Report FAIL * " );
		}
	}
	...
	public void IndividualClientReport(Map<Object, Object> testdatamap,Log Log) {
		...
		try {	
			...
			test.log(Status.FAIL,"#FUNC-Verify Individual client report FAIL" + driver.getTitle() +" * Verify Individual client report FAIL * " );
			this.takeScreenShot();
		}
	}
...
//			WebClick(EdaatOR.Admin_Report_VerifyPID);
			...
			test.log(Status.FAIL,"#FUNC-Ticket Size Report FAIL" + driver.getTitle() +" *Ticket Size Report FAIL * " );
			this.takeScreenShot();
		}
	}
	...
	public void VerifyCorporateBilllersReport(Log Log) throws InterruptedException {
		try {
			...
			test.log(Status.FAIL,"#FUNC-Verify Corporate Billers Report" + driver.getTitle() +" * Corporate Billers Report FAIL * " );
	...
	public void VerifySubBillesrReportErrorMsg(Map<Object,Object>testdatamap,Log Log) throws InterruptedException{
		{
			try {
				...
				test.log(Status.FAIL,WARNINGFontColorSuffix + "Error found at class: " + this.getClass().getName() + " Code line Number: "+ new Exception().getStackTrace()[0].getLineNumber() + "!" + WARNINGFontColorSuffix);
