		...
		try {
			...
			test.log(Status.PASS,"#FUNC-Verify Update and save Profile " + driver.getTitle() +" * Update Client Profile and Save is Pass * " );
		  	Log.ReportEvent("PASS", "Verify Update Client Profile Sucessful");
				...
				this.takeScreenShot();
				test.log(Status.FAIL,"#FUNC-Verify Update and save Profile " + driver.getTitle() +" * Update Client Profile and Save is Fail * " );
			}		
	}
...
//Function Parameters:SecondName,ThirdName,LastName and MobileNumber.
	...
	public void VerifyNewPwdNotMatchconfirmPwd(Map<Object, Object> testdatamap,Log Log)
	{
		...
		test.log(Status.FAIL,"#FUNC-Verify Incase New Password not match Confirm Password" + driver.getTitle() +" *  New Password not match Confirm Password is Fail * " );
		this.takeScreenShot();
		}
	...
	public void UpdateClientLoginInfoSave(Map<Object,Object>testdatamap,Log Log)
	{
		...
		{
			this.takeScreenShot();
			test.log(Status.FAIL,"#FUNC-Verify Update Client Login Info Save" + driver.getTitle() +" * Update Client Login Info Save is Pass * " );
		}
	...
	public void UpdateClientLoginInfoError(Map<Object, Object> testdatamap) {
		...
		{
			this.takeScreenShot();
			test.log(Status.FAIL,"#FUNC-Verify Update Client Login Info Error Message validation" + driver.getTitle() +" * Update Client Login Info  Error Message validation is Pass * " );
		}	
	...
	public void UpdateClientProfileAllfieldsError(Map<Object,Object>testdatamap) throws Exception
	{
	 try {
		...
		{
			this.takeScreenShot();
			test.log(Status.FAIL,"#FUNC-Verify Update Client Profile text fields" + driver.getTitle() +" * Update Client Profile text fields are Fail * " );
		}
	}		
}
