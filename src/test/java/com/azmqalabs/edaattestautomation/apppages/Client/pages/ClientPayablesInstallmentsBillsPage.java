...
public class ClientPayablesInstallmentsBillsPage extends BasePage {
	...
	public void InstallmentBillSearch(Map<Object, Object> testdatamap,Log Log) throws IOException
	{
		...
		test.log(Status.PASS,"#FUNC-Installment Bill Search" + driver.getTitle() +" * Installment Bill Search is PASS * ");
	      ...
	      test.log(Status.FAIL,"#FUNC-Installment Bill Search" + driver.getTitle() +" * Installment Bill Search is FAIL * ");
          this.takeScreenShot();
		}
	}
		public void InstallmentBillSContractclick(Map<Object, Object> testdatamap,Log Log) throws IOException
	{
		...
		this.takeScreenShot();
	      ...
	      test.log(Status.FAIL,"#FUNC-Contract number is Clickable" + driver.getTitle() +" *  Contract number is Clickable is FAIL * ");
		}
	}
