	...
	public void ExistsCheckElement(Log Log) throws InterruptedException {
		...
		try {
			...
			test.log(Status.FAIL,
					WARNINGFontColorPrefix + "launchApplication Page - loginToApplication failed - unable to Enter" + e
		 ...
		 public void LoginErrormessageValidation(Map<Object,Object> testdatamap) throws InterruptedException {
			 InvalidLoginError(testdatamap);	
				...
				try {
					...
					test.log(Status.FAIL,WARNINGFontColorPrefix + "launchApplication Page - loginToApplication failed - unable to Enter" + e+ WARNINGFontColorSuffix);
			...
			//Parameter Summary : LoginUserName,LoginPassword.
			 public void forgotPasswordErrormessageValidation(Map<Object,Object> testdatamap) throws InterruptedException {
				...
				public void validateCorrectClientIsLoginToTheClientAccount(Map<Object, Object> testdatamap, Log Log) throws IOException {
					...
					test.log(Status.PASS,"verify that when entering the contract number and redirecting to login as client they log by the correct client Functionality is successfull" + driver.getTitle() +" *verify that when entering the contract number and redirecting to login as client they log by the correct client Functionality is successfull PASS * " );
					this.takeScreenShot();
					}
					catch (Exception e) {
						e.printStackTrace();
					
					test.log(Status.FAIL,"Enter the contract number and click on PayNow Functionality is Unsuccessfull" + driver.getTitle() +" *Enter the contract number and click on PayNow Functionality is Unsuccessfull FAIL * " );	
					this.takeScreenShot();
					}
				}
}
